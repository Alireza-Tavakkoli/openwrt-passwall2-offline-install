...
## مقدمه
این آموزش برای نصب Passwall2 روی OpenWrt در حالت آفلاین (بدون داشتن اینترنت آزاد بر روی روتر به دلیل زندگی در ایران ) و استفاده از پکیج‌های آماده ساخته شده است.
